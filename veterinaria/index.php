...
<head>
    ...
    <title>Veterinaria - Sistema de Gestión</title>
    <!-- Agregar Bootstrap -->
...
<body>
    ...
    <main class="container mt-4">
        ...
        <p>Selecciona una opción del menú para gestionar la información.</p>
                ...
                <?php if ($mascotas->num_rows > 0): ?>
                    <?php while ($mascota = $mascotas->fetch_assoc()): ?>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button class="btn btn-warning btn-sm m-1 edit-btn" data-id="<?php echo $mascota['id']; ?>" data-nombre="<?php echo $mascota['nombre']; ?>" data-especie="<?php echo $mascota['especie']; ?>">Editar</button>
                                <button class="btn btn-danger btn-sm m-1 delete-btn" data-id="<?php echo $mascota['id']; ?>">Eliminar</button>
                            </div>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
